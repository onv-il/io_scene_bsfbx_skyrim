...
read_data_dict = {
    ...
    # array (float)
    b'f'[0]: lambda read: unpack_array(read, data_types.ARRAY_FLOAT32, 4, False),
    # array (int)
    b'i'[0]: lambda read: unpack_array(read, data_types.ARRAY_INT32, 4, True),
    # array (double)
    b'd'[0]: lambda read: unpack_array(read, data_types.ARRAY_FLOAT64, 8, False),
    # array (long)
    b'l'[0]: lambda read: unpack_array(read, data_types.ARRAY_INT64, 8, True),
    # array (bool)
    b'b'[0]: lambda read: unpack_array(read, data_types.ARRAY_BOOL, 1, False),
    # array (ubyte)
    b'c'[0]: lambda read: unpack_array(read, data_types.ARRAY_BYTE, 1, False),
}
